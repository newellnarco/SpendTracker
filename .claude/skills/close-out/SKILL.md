...
1. **Summarize** in three to eight lines: what was built, what was tested and how (which CI tiers ran: unit, integration, system), what is unfinished, what blocked you.
...
6. **Log the close entry** (this marks the session closed):
   `.claude/hooks/log.sh --session <sid> close "<summary>, PR #<n>, questions: <ids>, issues: <ids>"`
